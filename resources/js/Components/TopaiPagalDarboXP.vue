    ...
    <div class="row">
        <div class="col-md-4">
            <div class="top3-header">
                <span>TOP 3 Žaidėjai pagal darbo patirtį</span>
            </div>
            ...
            <div v-if="ShowTopOneDiv == 1" @click="CloseTopOne">
                <div class="top1-clicked">
                    ...
                    <span v-for="(item) in TopOne" class="players-xp">{{Number(item.VisasDarboXP).toLocaleString()}} XP.</span>
            ...
            <div v-if="ShowTopTwoDiv == 1" @click="CloseTopTwo">
                <div class="top2-clicked">
                    ...
                    <span v-for="(item) in TopTwo" class="players-xp-2">{{Number(item.VisasDarboXP).toLocaleString()}} XP.</span>
            ...
            <div v-if="ShowTopThreeDiv == 1" @click="CloseTopThree">
                <div class="top3-clicked">
                    ...
                    <span v-for="(item) in TopThree" class="players-xp-3">{{Number(item.VisasDarboXP).toLocaleString()}} XP.</span>
                    <div class="more-info" v-for="(item) in TopThree">
                        ...
                        <br>
                        <span class='main-textas-3 darbo-patirtis'>Alga</span> <span class="result-textas">{{ Number(item.pinigai).toLocaleString() }} &euro;</span>
                        <br>
        ...
        <div class="col-md-8 mt4 mobile-padding">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <th scope="col">Darbo patirtis</th>
                    ...
                    <tr v-for="(item, index) in Topai">
                        ...
                        <td class="PlayerXP padding">{{ Number(item.VisasDarboXP).toLocaleString() }} XP.</td>
...
export default {
    ...
    created() {
        axios.get("/TopsByWorkXP",).then((res) => {
            this.Topai = res.data;
        });
        axios.get("/TopOneByWorkXp",).then((res) => {
            this.TopOne = res.data;
        });
        axios.get("/TopTwoByWorkXp",).then((res) => {
            this.TopTwo = res.data;
        });
        axios.get("/TopThreeByWorkXp",).then((res) => {
