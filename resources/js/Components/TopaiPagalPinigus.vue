        ...
        <div class="col-md-4">
            ...
            <div v-if="ShowTopOneDiv == 1" @click="CloseTopOne">
                <div class="top1-clicked">
                    ...
                    <span v-for="(item) in TopOne" class="players-xp">{{Number(item.pinigai).toLocaleString()}} &euro;</span>
            ...
            <div v-if="ShowTopTwoDiv == 1" @click="CloseTopTwo">
                <div class="top2-clicked">
                    ...
                    <span v-for="(item) in TopTwo" class="players-xp-2">{{Number(item.pinigai).toLocaleString()}} &euro;</span>
            ...
            <div v-if="ShowTopThreeDiv == 1" @click="CloseTopThree">
                <div class="top3-clicked">
                    ...
                    <span v-for="(item) in TopThree" class="players-xp-3">{{Number(item.pinigai).toLocaleString()}} &euro;</span>
...
export default {
    ...
    created() {
        ...
        axios.get("/TopOneByMoney",).then((res) => {
            this.TopOne = res.data;
        });
        axios.get("/TopTwoByMoney",).then((res) => {
            this.TopTwo = res.data;
        });
        axios.get("/TopThreeByMoney",).then((res) => {
